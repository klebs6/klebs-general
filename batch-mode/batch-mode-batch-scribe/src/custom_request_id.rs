// ---------------- [ File: batch-mode-batch-scribe/src/custom_request_id.rs ]
crate::ix!();
...
mod custom_request_id_tests {
    ...
    fn test_custom_request_id_creation() {
        ...
        pretty_assert_eq!(id.as_str(), "custom_123");
    }
    ...
    fn test_custom_request_id_serialization() {
        ...
        pretty_assert_eq!(serialized, "\"custom_456\"");
    }
    ...
    fn test_custom_request_id_deserialization() {
        ...
        pretty_assert_eq!(id.as_str(), "custom_789");
    }
}
