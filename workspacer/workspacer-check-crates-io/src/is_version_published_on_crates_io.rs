...
mod test_is_crate_version_published_on_crates_io {
    ...
    // ------------------------------------------------------------------------
    #[traced_test]
    async fn test_live_call_crates_io_exists() {
    ...
    // ------------------------------------------------------------------------
    #[traced_test]
    async fn test_live_call_crates_io_does_not_exist() {
    ...
    #[traced_test]
    async fn test_is_crate_version_published_with_mock() {
    ...
    #[cfg(feature = "mock_http")]
    #[traced_test]
    async fn test_is_crate_version_published_mock_500() {
        use mockito::{mock, server_address};
        let crate_name = "my_mock_crate";
        let crate_version = Version::parse("1.2.3").unwrap();
        let url_path = format!("/api/v1/crates/{}/{}", crate_name, crate_version);
